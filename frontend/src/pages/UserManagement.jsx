    ...
    <div className="user-management">
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <NavLink to="/roles" className="nav-item">Roles &amp; Permissions</NavLink>
          <NavLink to="/services" className="nav-item">Service Catalog</NavLink>
          <NavLink to="/audit" className="nav-item">Audit Logs</NavLink>
        </nav>
                    ...
                    <tr key={user.user_id} className={selectedUsers.includes(user.user_id) ? 'row-selected' : ''}>
                      ...
                      <td>
                        <div className="user-cell-name">
                          ...
                          <span className="user-cell-meta">{user.staff_id || 'No Staff ID'}</span>
                        </div>
                      </td>
                      <td>{user.username}</td>
